...
// Complete raw items from the prompt
...
export const ALL_ITEMS: ItemDef[] = [
  ...
  },
  {
    ...
    shortName: 'GEO',
    aliases: ['B.E. Geo Informatics Engineering', 'Geo Informatics', 'Geoinformatics', 'GIS', 'Remote Sensing'],
    category: 'engineering',
    group: 'CIVIL',
    source: 'Anna University',
  },
  ...
  },
  {
    ...
    shortName: 'EST',
    aliases: ['Environmental Science and Technology', 'EST'],
    category: 'engineering',
    group: 'CIVIL',
    source: 'Anna University',
  },
  ...
  },
  {
    ...
    name: 'Planning',
    shortName: 'B.Plan',
    aliases: ['B.Plan.', 'B.Plan', 'Bachelor of Planning', 'Town Planning', 'Urban Planning'],
    category: 'engineering',
    group: 'CIVIL',
    source: 'Anna University',
  },
  ...
  // MECHANICAL
  {
    ...
    shortName: 'MECH',
    aliases: ['Mechanical', 'Mech Engg', 'BE Mechanical', 'B.E Mech', 'MECH'],
    category: 'engineering',
    group: 'MECHANICAL',
    source: 'Anna University',
  },
  ...
  },
  {
    ...
    shortName: 'PRINT',
    aliases: ['Printing Technology', 'Packaging Technology', 'Printing and Packaging'],
    category: 'engineering',
    group: 'MECHANICAL',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'MFG',
    aliases: ['Manufacturing', 'Manufacturing Engg'],
    category: 'engineering',
    group: 'MECHANICAL',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'IE',
    aliases: ['Industrial', 'Industrial Engg', 'IE'],
    category: 'engineering',
    group: 'MECHANICAL',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'AERO',
    aliases: ['Aeronautical', 'Aero Engg', 'Aeronautics'],
    category: 'engineering',
    group: 'MECHANICAL',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'AUTO',
    aliases: ['Automobile', 'Auto Engg', 'Automotive'],
    category: 'engineering',
    group: 'MECHANICAL',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'PROD',
    aliases: ['Production', 'Production Engg'],
    category: 'engineering',
    group: 'MECHANICAL',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'ROBOTICS',
    aliases: ['B.E. Robotics and Automation', 'Robotics', 'Automation', 'Robotics Engineering', 'Robotics and Automation'],
    category: 'engineering',
    group: 'MECHANICAL',
    source: 'Anna University',
  },
  {
    ...
    aliases: ['Mechatronics', 'Mechatronics Engg'],
    category: 'engineering',
    group: 'MECHANICAL',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'MAE',
    aliases: ['Mechanical and Automation', 'MAE'],
    category: 'engineering',
    group: 'MECHANICAL',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'IEM',
    aliases: ['IEM', 'Industrial Management'],
    category: 'engineering',
    group: 'MECHANICAL',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'MARINE',
    aliases: ['Marine', 'Marine Engg', 'Nautical'],
    category: 'engineering',
    group: 'MECHANICAL',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'AEROSPACE',
    aliases: ['Aerospace', 'Aerospace Engg'],
    category: 'engineering',
    group: 'MECHANICAL',
    source: 'Anna University',
  },
  ...
  },
  {
    ...
    aliases: ['Smart Manufacturing', 'Industry 4.0', 'B.E. Mechanical (Smart Manufacturing)'],
    category: 'engineering',
    group: 'MECHANICAL',
    source: 'Anna University',
  },
  ...
  // ELECTRICAL / ELECTRONICS
  {
    ...
    shortName: 'EEE',
    aliases: ['EEE', 'Electrical', 'B.E EEE', 'Electrical & Electronics', 'BE EEE'],
    category: 'engineering',
  ...
  },
  {
    ...
    shortName: 'ECompE',
    aliases: ['Electrical and Computer', 'ECompE'],
    category: 'engineering',
    group: 'ELECTRICAL / ELECTRONICS',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'EIE',
    aliases: ['EIE', 'Instrumentation', 'Electronics & Instrumentation'],
    category: 'engineering',
    group: 'ELECTRICAL / ELECTRONICS',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'ICE',
    aliases: ['ICE', 'Instrumentation and Control', 'Instrumentation & Control'],
    category: 'engineering',
    group: 'ELECTRICAL / ELECTRONICS',
    source: 'Anna University',
  },
  ...
  },
  {
    ...
    shortName: 'ECE',
    aliases: ['ECE', 'Electronics', 'Electronics & Communication', 'B.E ECE', 'BE ECE'],
    category: 'engineering',
    group: 'ELECTRICAL / ELECTRONICS',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'BME',
    aliases: ['BME', 'Biomedical', 'Biomedical Engg', 'B.E BME', 'BE BME'],
    category: 'engineering',
    group: 'ELECTRICAL / ELECTRONICS',
    source: 'Anna University',
  },
  ...
  },
  {
    ...
    shortName: 'ECE (Comp)',
    aliases: ['Electronics and Computer', 'Electronics & Computer'],
    category: 'engineering',
    group: 'ELECTRICAL / ELECTRONICS',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'ETE',
    aliases: ['Telecommunication', 'Telecommunication Engg', 'ETE'],
    category: 'engineering',
    group: 'ELECTRICAL / ELECTRONICS',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'VLSI',
    aliases: ['VLSI', 'VLSI Design', 'B.Tech VLSI', 'B.E. VLSI', 'Electronics Engineering VLSI', 'VLSI Design and Technology'],
    category: 'engineering',
    group: 'ELECTRICAL / ELECTRONICS',
    source: 'Anna University',
  },
  ...
  // COMPUTER / IT
  {
    ...
    shortName: 'CSE',
    aliases: ['CSE', 'Computer Science', 'BE CSE', 'B.E CSE', 'CS', 'Computer Science and Engineering'],
    category: 'engineering',
    group: 'COMPUTER / IT',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'CCE',
    aliases: ['CCE', 'Computer and Communication', 'Computer & Communication'],
    category: 'engineering',
    group: 'COMPUTER / IT',
    source: 'Anna University',
  },
  ...
  },
  {
    ...
    shortName: 'CSD',
    aliases: ['CSD', 'Computer Science and Design', 'CS and Design'],
    category: 'engineering',
    group: 'COMPUTER / IT',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'IT',
    aliases: ['IT', 'Info Tech', 'B.Tech IT', 'B.Tech Information Technology', 'Information Technology'],
    category: 'engineering',
    group: 'COMPUTER / IT',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'AI & DS',
    aliases: ['AIDS', 'AI & DS', 'AI and Data Science', 'B.Tech AIDS', 'B.Tech AI & DS', 'Artificial Intelligence & Data Science'],
    category: 'engineering',
    group: 'COMPUTER / IT',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'AI & ML',
    aliases: ['AIML', 'AI & ML', 'AI and Machine Learning', 'B.Tech AIML', 'B.Tech AI & ML', 'Artificial Intelligence & Machine Learning'],
    category: 'engineering',
    group: 'COMPUTER / IT',
    source: 'Anna University',
  },
  {
    ...
    shortName: 'CSBS',
    aliases: ['CSBS', 'CS and Business Systems', 'B.Tech CSBS', 'TCS CSBS'],
    category: 'engineering',
    group: 'COMPUTER / IT',
    source: 'Anna University',
  },
  ...
  },
  {
    ...
    aliases: ['English CA', 'English with Computer Applications', 'BA English CA'],
    category: 'arts_science',
    group: 'ARTS',
    source: 'Bharathiar University',
  },
  ...
  },
  {
    ...
    aliases: ['Tourism', 'Travel Management', 'Tourism and Travel Management', 'BA Tourism'],
    category: 'arts_science',
    group: 'ARTS',
    source: 'Bharathiar University',
  },
  {
    ...
    aliases: ['Economics CA', 'Economics with CA', 'BA Economics CA'],
    category: 'arts_science',
    group: 'ARTS',
    source: 'Bharathiar University',
  },
  {
    ...
    aliases: ['Economics Banking and Insurance', 'Economics BI'],
    category: 'arts_science',
    group: 'ARTS',
    source: 'Bharathiar University',
  },
  {
    ...
    name: 'Carnatic Music',
    shortName: 'BA Music',
    aliases: ['Carnatic Music', 'Music', 'BA Music'],
    category: 'arts_science',
    group: 'ARTS',
    source: 'Bharathiar University',
  },
  {
    ...
    aliases: ['B.A. Defence and Strategic Studies', 'Defence', 'Defence Studies', 'Strategic Studies', 'BA Defence'],
    category: 'arts_science',
    group: 'ARTS',
    source: 'Bharathiar University',
  },
  ...
  },
  {
    ...
    aliases: ['Performing Arts', 'Drama', 'Dance', 'Theatre'],
    category: 'arts_science',
    group: 'ARTS',
    source: 'Bharathiar University',
  },
  {
    ...
    aliases: ['B.A. Criminology and Police Administration', 'Criminology', 'Police Administration', 'BA Criminology'],
    category: 'arts_science',
    group: 'ARTS',
    source: 'Bharathiar University',
  },
  {
    ...
    aliases: ['Journalism', 'Mass Communication', 'BA Journalism', 'BA Mass Comm'],
    category: 'arts_science',
    group: 'ARTS',
    source: 'Bharathiar University',
  },
  ...
  // ── 5. MANAGEMENT — B.B.A. ──
  {
    ...
    shortName: 'BBA',
    aliases: ['BBA', 'Bachelor of Business Administration', 'Business Administration'],
    category: 'arts_science',
    group: 'MANAGEMENT',
    source: 'Bharathiar University',
  },
  ...
  },
  {
    ...
    aliases: ['B.B.A. Logistics', 'BBA Logistics', 'Logistics', 'Supply Chain Management', 'SCM', 'Logistics and Supply Chain Management'],
    category: 'arts_science',
    group: 'MANAGEMENT',
    source: 'Bharathiar University',
  },
  ...
  // ── 6. COMPUTER APPLICATIONS ──
  {
    ...
    shortName: 'BCA',
    aliases: ['B.C.A.', 'BCA', 'Bachelor of Computer Applications', 'Computer Applications', 'CA'],
    category: 'arts_science',
    group: 'COMPUTER / IT',
    source: 'Bharathiar University',
  },
  ...
  // ── 7. COMMERCE — B.COM. ──
  {
    ...
    name: 'Commerce',
    shortName: 'B.Com',
    aliases: ['B.Com', 'BCom', 'Bachelor of Commerce', 'General Commerce'],
    category: 'arts_science',
    group: 'COMMERCE',
    source: 'Bharathiar University',
  },
  ...
  },
  {
    ...
    shortName: 'B.Com (BF)',
    aliases: ['B.Com. Banking', 'Banking and Finance', 'Banking', 'BCom Banking', 'Finance'],
    category: 'arts_science',
    group: 'COMMERCE',
    source: 'Bharathiar University',
  },
  ...
  },
  {
    ...
    aliases: ['Capital Markets', 'Stock Market'],
    category: 'arts_science',
    group: 'COMMERCE',
    source: 'Bharathiar University',
  },
  ...
  },
  {
    ...
    shortName: 'B.Com (CS)',
    aliases: ['B.Com CS', 'Corporate Secretaryship', 'Corporate', 'BCom CS'],
    category: 'arts_science',
    group: 'COMMERCE',
    source: 'Bharathiar University',
  },
  {
    ...
    aliases: ['Corporate Secretaryship CA', 'CS with CA', 'BCom CS CA'],
    category: 'arts_science',
    group: 'COMMERCE',
    source: 'Bharathiar University',
  },
  {
    ...
    aliases: ['B.Com. Cost and Management Accounting', 'Cost Accounting', 'CMA', 'Cost & Management'],
    category: 'arts_science',
    group: 'COMMERCE',
    source: 'Bharathiar University',
  },
  ...
  },
  {
    ...
    shortName: 'B.Com (PA)',
    aliases: ['B.Com PA', 'Professional Accounting', 'BCom PA', 'BCom Professional Accounting', 'PA'],
    category: 'arts_science',
    group: 'COMMERCE',
    source: 'Bharathiar University',
  },
  ...
  },
  {
    ...
    shortName: 'B.Com (A&F)',
    aliases: ['B.Com AF', 'Accounting and Finance', 'BCom Accounting and Finance', 'Accounting & Finance'],
    category: 'arts_science',
    group: 'COMMERCE',
    source: 'Bharathiar University',
  },
  {
    ...
    specialization: 'Computer Applications',
    shortName: 'B.Com (CA)',
    aliases: ['B.Com CA', 'BCom CA', 'Commerce with Computer Applications', 'CA'],
    category: 'arts_science',
    group: 'COMMERCE',
    source: 'Bharathiar University',
  },
  ...
  },
  {
    ...
    aliases: ['Data Science', 'Data Analytics', 'B.Sc. Computer Science with Data Analytics'],
    category: 'arts_science',
    group: 'COMPUTER / IT',
    source: 'Bharathiar University',
  },
  {
    ...
    aliases: ['B.Sc AI', 'Artificial Intelligence'],
    category: 'arts_science',
    group: 'COMPUTER / IT',
    source: 'Bharathiar University',
  },
  ...
  },
  {
    ...
    name: 'Artificial Intelligence and Machine Learning',
    shortName: 'B.Sc AIML',
    aliases: ['AIML', 'BSc AIML', 'AI and Machine Learning', 'B.Sc AI & ML'],
    category: 'arts_science',
    group: 'COMPUTER / IT',
    source: 'Bharathiar University',
  },
  {
    ...
    aliases: ['AIDS', 'BSc AIDS', 'AI and Data Science', 'B.Sc AI & DS'],
    category: 'arts_science',
    group: 'COMPUTER / IT',
    source: 'Bharathiar University',
  },
  {
    ...
    aliases: ['Data Science', 'BSc Data Science', 'B.Sc Data Analytics'],
    category: 'arts_science',
    group: 'COMPUTER / IT',
    source: 'Bharathiar University',
  },
  {
    ...
    shortName: 'B.Sc DSA',
    aliases: ['Data Analytics', 'Data Science & Analytics', 'DSA'],
    category: 'arts_science',
    group: 'COMPUTER / IT',
    source: 'Bharathiar University',
  },
  ...
  },
  {
    ...
    aliases: ['Cyber Security', 'Cyber', 'BSc Cyber Security'],
    category: 'arts_science',
    group: 'COMPUTER / IT',
    source: 'Bharathiar University',
  },
  ...
  },
  {
    ...
    aliases: ['Hardware and Networking', 'Networking', 'Hardware Systems'],
    category: 'arts_science',
    group: 'COMPUTER / IT',
    source: 'Bharathiar University',
  },
  ...
  },
  {
    ...
    aliases: ['Maths CA', 'Mathematics with CA', 'BSc Maths CA'],
    category: 'arts_science',
    group: 'SCIENCE',
    source: 'Bharathiar University',
  },
  ...
  },
  {
    ...
    aliases: ['Renewable Energy', 'Solar Energy', 'Green Energy'],
    category: 'arts_science',
    group: 'SCIENCE',
    source: 'Bharathiar University',
  },
  {
    ...
    aliases: ['Wildlife Biology', 'Wildlife', 'Wild Life'],
    category: 'arts_science',
    group: 'SCIENCE',
    source: 'Bharathiar University',
  },
  ...
  },
  {
    ...
    aliases: ['Food Science', 'Food Sciences and Nutrition', 'B.Sc. Food Science and Nutrition'],
    category: 'arts_science',
    group: 'SCIENCE',
    source: 'Bharathiar University',
  },
...
console.log('Total Canonical Master Programmes:', ALL_ITEMS.length);
